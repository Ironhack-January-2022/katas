...
// iterate over recipe
// get every key -> access the value in ingredient and divide it by the value in 
// available (using that key we are at)
// add the result to an array
// when we looped over all the keys of recipe -> return the lowest number of the
// array
...
function cakes(recipe, available) {
	...
	for (let ingredient in recipe) {
		...
		amounts.push(available[ingredient] / recipe[ingredient])
	}
